...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        Steerage steerage = new Steerage();
        ...
        PassengerCar car = new PassengerCar(4,2,5,2000, petrolEngine,transmission,steerage, "Sedan");
        PassengerCar car1 = new PassengerCar(4,2,5,2000, petrolEngine,transmission1, steerage,"Sedan");
        PassengerCar car2 = new PassengerCar(4,2,5,2000, dieselEnginelEngine,transmission1, steerage,"Sedan");
        Truck truck = new Truck(6, 3,3,5000,dieselEnginelEngine, transmission, steerage,10000);
//        car.onElectric();
...
//        car.off();
        ...
        car1.right(airConditioning, 5);
        car1.currentSpeed(60);
        car1.left(steerage, 90);
        car1.currentSpeed(20);
        car1.left(airConditioning, 10);
        car1.right(steerage, 90);
        car1.currentSpeed(0);
